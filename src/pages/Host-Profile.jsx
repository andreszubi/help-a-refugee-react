        ...
        <div className="PublishListing">
            ...
            <div>
                ...
                <form onSubmit={event => handleSubmit(event)}>
                    ...
                    <label>Country: <input type="text" name="newCountry" required onChange={event => setNewCountry(event.target.value)} /></label> 

                    <label>City: <input type="text" name="newCity" required onChange={event => setNewCity(event.target.value)} /></label>   

                    <label>Type of Room: <input type="text" name="newTypeOfRoom" required onChange={event => setNewTypeOfRoom(event.target.value)} /></label>

                    <label>Places Available: <input type="number" name="newPlacesAvailable" required onChange={event => setNewPlacesAvailable(event.target.value)} /></label>

                    <label>Image: <input type="file" name="newImage" onChange={event => setNewImage(event.target.value)} /></label>
